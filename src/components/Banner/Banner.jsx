    ...
    <div className="min-h-[550px] flex justify-center items-center py-12">
      <div className="container">
        <div style={{backgroundColor: data.bgColor}} className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
            ...
            <p className="text-sm">{data.desconto}</p>
            <h1 className="uppercase text-4xl lg:text-7xl font-bold">{data.titulo}</h1>
            ...
            <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                <p className="font-bold text-xl">{data.titulo2}</p>
                <p className="text-3xl sm:text-5xl font-bold">{data.titulo3}</p>
                <p className="text-sm tracking-wide leading-5">{data.titulo4}</p>
                <div>
